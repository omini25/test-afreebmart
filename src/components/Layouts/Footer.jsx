        ...
        <div className="bg-[#000] text-white">
            <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-primary py-7">
                <h2 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5">
                    <span className="text-black">Subscribe</span> for the latest{" "}
                    <br />
                    products and offers
                </h2>
                <div>
            ...
            <div className="grid grid-cols-1 sm:gird-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center">
                <ul className="px-5 text-center sm:text-start flex sm:block flex-col items-center">
                    ...
                    />
                    <br />
                    <p>Welcome to Afreebmart! Explore fresh, high-quality agricultural food items sourced directly from trusted vendors and suppliers.</p>
         ...
         text-center pt-2 text-gray-400 text-sm pb-8"
            >
                <span>© 2024 Afreebmart. All rights reserved.</span>
