    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.user) {
                ...
                localStorage.setItem('user', JSON.stringify(response.data.user)); // Save the user data in localStorage
                Cookies.set('access_token', response.data.access_token, { expires: 7 });
                dispatch(userLogin(response.data.user)); // Dispatch the user login action
